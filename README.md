...
1. How would you describe acessibility on the web to someone new to programming? it is important to desgin your page with acessibility because the internet is for everbody and should be acessible to everyone no matter what
2. Talk about 3 different things you can do to ensure your website is accessible. 
make sure you're using semantic tags and make sure you put alts on images
3. How would you explain the concept of a variable to someone new to programming?
a variable is like a container it holds data
4. What is the purpose of using functions in code?
functions are good for reuseable code
